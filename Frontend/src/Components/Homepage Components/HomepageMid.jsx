...
>
  <GridItem colSpan={6}>
    <Image src="https://cdn.fcglcdn.com/brainbees/images/cattemplate/1920_447_desktop_SOI_2023_01.jpg" alt="top-img1"/>
  </GridItem>
  <GridItem colSpan={2}>
    <Image src="https://cdn.fcglcdn.com/brainbees/images/cattemplate/fashion_desktop_SOI_060123_02.jpg" alt="top-img2"/>
  </GridItem>
  <GridItem colSpan={2}>
    <Image src="https://cdn.fcglcdn.com/brainbees/images/cattemplate/fashion_desktop_SOI_060123_03.jpg" alt="top-img3"/>
  </GridItem>
  <GridItem colSpan={2}>
    <Image src="https://cdn.fcglcdn.com/brainbees/images/cattemplate/fashion_desktop_SOI_060123_04.jpg" alt="top-img4"/>
  </GridItem>
</Grid>
        </Box>
        <Box className='brands-css'>
        <Box>
            <Image src="https://cdn.fcglcdn.com/brainbees/images/cattemplate/1920_179_desktop_SOI_2023_05.jpg" alt="top-img5"/>
        </Box>
        <Box>
        <SimpleGrid columns={[2, null, 4]}>
            <Box maxWidth="315px" >
                <Image src="https://cdn.fcglcdn.com/brainbees/images/cattemplate/fashion_desktop_SOI_060123_05.jpg" alt="top-img6"/>
            </Box>
            <Box maxWidth="315px">
            <Image src="https://cdn.fcglcdn.com/brainbees/images/cattemplate/fashion_desktop_SOI_060123_06.jpg" alt="top-img6"/>
            </Box>
            <Box maxWidth="315px">
            <Image src="https://cdn.fcglcdn.com/brainbees/images/cattemplate/fashion_desktop_SOI_060123_07.jpg" alt="top-img6"/>
            </Box>
            <Box maxWidth="315px">
            <Image src="https://cdn.fcglcdn.com/brainbees/images/cattemplate/fashion_desktop_SOI_060123_08.jpg" alt="top-img6"/>
            </Box>
        </SimpleGrid>
        </Box>
        <Box>
            <Image src="https://cdn.fcglcdn.com/brainbees/images/cattemplate/1920_228_desktop_SOI_2023_18.jpg" alt="brand banner" />
        </Box>
        <SimpleGrid columns={[4, null, 8]} spacing='5px'>
            {brand.map((data, index) =>{
                return <Box key = {index+3}>
